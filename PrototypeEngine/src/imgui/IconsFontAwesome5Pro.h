...
#define FONT_ICON_FILE_NAME_FAL PROTOTYPE_FONT_PATH("fa-light-300.ttf")
#define FONT_ICON_FILE_NAME_FAR PROTOTYPE_FONT_PATH("fa-regular-400.ttf")
#define FONT_ICON_FILE_NAME_FAS PROTOTYPE_FONT_PATH("fa-solid-900.ttf")
