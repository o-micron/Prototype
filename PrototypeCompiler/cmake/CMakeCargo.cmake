function(cargo_build)
    ...
    set(DLL_FILE "${CARGO_TARGET_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${CMAKE_STATIC_LIBRARY_PREFIX}${LIB_NAME}.dll")
    ...
    add_custom_command(TARGET ${CARGO_NAME}_target POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E copy ${DLL_FILE} ${CMAKE_BINARY_DIR}/bin/assets/plugins/${LIB_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}
    )
endfunction()