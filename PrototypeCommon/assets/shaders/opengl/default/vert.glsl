...
layout(location = 2) flat out float _ObjectId;
layout(location = 3) out vec2       _Texcoord;
...
main()
{
    ...
    _Texcoord   = vec2(inPositionU.w + TileSize / TileSize, inNormalV.w + TileSize / TileSize) / vec2(TileSize, TileSize);
